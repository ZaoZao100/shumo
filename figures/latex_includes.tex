\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_roadmap.pdf}
\caption{全文技术路线}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_att1_profile.pdf}
\caption{附件一平均日断面}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=118.00mm,keepaspectratio]{figures/tikz_feasible_q1.pdf}
\caption{相邻两段可行域示意}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=118.00mm,keepaspectratio]{figures/tikz_soc_corridor.pdf}
\caption{储电量可行走廊示意}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_q2_margin_ucurve.pdf}
\caption{点预测基线的裕度与风险权衡}
\label{fig:fig_q2_margin_ucurve}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=140.00mm,keepaspectratio]{figures/tikz_info_set.pdf}
\caption{滚动决策信息集示意}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_q3_rolling_timeline.pdf}
\caption{日前计划与滚动执行对照}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_q3_cost_decomp.pdf}
\caption{滚动调整的净收益来源}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=146.25mm,keepaspectratio]{figures/fig_q3_interp_check.pdf}
\caption{预报插值一致性核查}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_q4_price_ridgeline.pdf}
\caption{逐月电价与固定基准对照}
...
\caption{滚动策略收益区间与季节分解}
\label{fig:fig_rolling_benefit_uncertainty}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=150.00mm,keepaspectratio]{figures/fig_arch_solver.pdf}
\caption{求解导出与交叉回算流程}
